	...
	<div class="normalcell spacer-top spacer-bottom">
		...
		<?php endif;?>
			...
			<div style="display: inline-block; width: 140px; vertical-align: top">
				...
				<span style="color: #51b15c; font-size: 20px; margin-right: 5px; vertical-align: middle">&#8226</span><a href="<?php echo url_for('@film_buy?id=' . $film->getId() . '&key=' . $film->getUrlKey());?>">Cumpara DVD & Bluray</a>
				<div class="mb-1"></div>
				<?php endif;?>
				<?php if ($film->isInCinema()):?>
				<span style="color: #51b15c; font-size: 20px; margin-right: 5px; vertical-align: middle">&#8226</span><a href="<?php echo url_for('@film_tickets?id=' . $film->getId() . '&key=' . $film->getUrlKey());?>">Rezerva bilete</a>
				<div class="mb-1"></div>
				<?php endif;?>
				<span style="color: #51b15c; font-size: 20px; margin-right: 5px; vertical-align: middle">&#8226</span><a href="<?php echo url_for('@film_cast?id=' . $film->getId() . '&key=' . $film->getUrlKey());?>">Actori & echipa<span class="filter-cioc"></span></a>
				<div class="mb-1"></div>
				<span style="color: #51b15c; font-size: 20px; margin-right: 5px; vertical-align: middle">&#8226</span><a href="<?php echo url_for('@film_sinopsis?id=' . $film->getId() . '&key=' . $film->getUrlKey());?>">Sinopsis<span class="filter-cioc"></span></a>
			</div>
