...
class CinemaPromotion extends BaseCinemaPromotion
{
	public function preDelete($event)
	{
		...
		unlink(sfConfig::get('app_cinemapromotion_path') . '/' . $event->getInvoker()->getFilename());
		unlink(sfConfig::get('app_cinemapromotion_path') . '/t-' . $event->getInvoker()->getFilename());
		unlink(sfConfig::get('app_cinemapromotion_path') . '/ts-' . $event->getInvoker()->getFilename());
	...
	{
		$sourceFile = sfConfig::get('app_cinemapromotion_path') . '/' . $this->getFilename();
