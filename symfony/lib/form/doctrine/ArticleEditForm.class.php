...
public function configure()
	...
	public function updateObject($values = null)
  {
  	...
  	/* Delete old files */
    @unlink(sfConfig::get('app_article_path'). '/' . $this->getObject()->getFilename());
    @unlink(sfConfig::get('app_article_path'). '/t-' . $this->getObject()->getFilename());
    @unlink(sfConfig::get('app_article_path'). '/ts-' . $this->getObject()->getFilename());
