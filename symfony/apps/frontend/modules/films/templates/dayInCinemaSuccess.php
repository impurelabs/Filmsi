...
<div class="cell-container6"> <!-- left column start -->
	<form action="<?php echo url_for('@film_day_in_cinema?day=' . $sf_request->getParameter('day'));?>" method="get" id="filter-form">
    ...
    <div class="spacer-bottom">
        <span class="daypicker-s-day<?php if ($days[1] == $sf_request->getParameter('day')) echo '-active';?>" id="day_trigger_1" onclick="location.href='<?php echo url_for('@film_day_in_cinema?day=' . $days[1]);?>'">L</span>
        <span class="daypicker-s-day<?php if ($days[2] == $sf_request->getParameter('day')) echo '-active';?>" id="day_trigger_2" onclick="location.href='<?php echo url_for('@film_day_in_cinema?day=' . $days[2]);?>'">M</span>
        <span class="daypicker-s-day<?php if ($days[3] == $sf_request->getParameter('day')) echo '-active';?>" id="day_trigger_3" onclick="location.href='<?php echo url_for('@film_day_in_cinema?day=' . $days[3]);?>'">M</span>
        <span class="daypicker-s-day<?php if ($days[4] == $sf_request->getParameter('day')) echo '-active';?>" id="day_trigger_4" onclick="location.href='<?php echo url_for('@film_day_in_cinema?day=' . $days[4]);?>'">J</span>
        <span class="daypicker-s-day<?php if ($days[5] == $sf_request->getParameter('day')) echo '-active';?>" id="day_trigger_5" onclick="location.href='<?php echo url_for('@film_day_in_cinema?day=' . $days[5]);?>'">V</span>
        <span class="daypicker-s-day<?php if ($days[6] == $sf_request->getParameter('day')) echo '-active';?>" id="day_trigger_6" onclick="location.href='<?php echo url_for('@film_day_in_cinema?day=' . $days[6]);?>'">S</span>
        <span class="daypicker-s-day<?php if ($days[7] == $sf_request->getParameter('day')) echo '-active';?>" id="day_trigger_7" onclick="location.href='<?php echo url_for('@film_day_in_cinema?day=' . $days[7]);?>'">D</span>
        <div class="clear"></div>
    </div>
...
<div class="cell-container5 spacer-left"> <!-- content column start -->
    ...
    <div class="spacer-bottom">
    	<button class="normalbutton spacer-left" onclick="location.href='<?php echo url_for('@film_now_in_cinema');?>'"><span class="icon-buttonbullet-grey"></span> <span class="bigstronggrey">Arata filmele care ruleaza</span></button>
    ...
    <div class="cell-separator-dotted-top cell-separator-dotted-bottom innerspacer-bottom innerspacer-top"> <!-- page navigator start -->
        ...
        <?php if($currentPage > 1):?>
			<a href="<?php echo url_for('@film_day_in_cinema?day=' . $sf_request->getParameter('day'));?>?<?php if ($parameterQuery != '') echo $parameterQuery . '&';?>p=<?php echo $currentPage - 1;?>"><span class="pagenav-back"></span></a>
		<?php endif;?>
		<?php for ($i = 1; $i <= $pageCount; $i++):?>
			<a href="<?php echo url_for('@film_day_in_cinema?day=' . $sf_request->getParameter('day'));?>?<?php if ($parameterQuery != '') echo $parameterQuery . '&';?>p=<?php echo $i;?>"><span class="<?php echo $i == $currentPage ? 'pagenav-active' : 'pagenav';?>"><?php echo $i;?></span></a>
		<?php endfor;?>
		<?php if($currentPage < $pageCount):?>
		<a href="<?php echo url_for('@film_day_in_cinema?day=' . $sf_request->getParameter('day'));?>?<?php if ($parameterQuery != '') echo $parameterQuery . '&';?>p=<?php echo $currentPage + 1;?>"><span class="pagenav-forward"></span></a>
		<?php endif;?>
