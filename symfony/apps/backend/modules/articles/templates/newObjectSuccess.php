...
<h4 class="mb-3">Creeaza Articol Nou</h4>

<form id="the-form" action="<?php echo url_for('@default?module=articles&action=newObject');?>" method="post" enctype="multipart/form-data">
