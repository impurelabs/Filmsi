...
<h6 class="mb-3"><?php echo $cinemaSchedule->getFilmNotInDb() == '1' ? $cinemaSchedule->getFilmName() : $cinemaSchedule->getFilm()->getName();?> - <?php echo $cinemaSchedule->getDay();?></h6>
...
<form action="<?php echo url_for('@default?module=cinemas&action=editSchedule');?>?id=<?php echo $cinemaSchedule->getId();?>" method="post">
    ...
    Format:<br />
    <?php echo $form['format']->render();?><br />
