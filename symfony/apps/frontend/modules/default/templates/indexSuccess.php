      ...
      <div class="cell">
        ...
        <div class="cell-bd" style="height: 450px">
			<?php foreach ($filmsNowInCinema as $filmNowInCinema):?>
				...
				<div class="detailscell"> <a href="<?php echo url_for('@film?id=' . $filmNowInCinema->getId() . '&key=' . $filmNowInCinema->getUrlKey());?>" class="left"><img width="100" src="<?php echo filmsiFilmPhotoThumb($filmNowInCinema->getFilename());?>" /></a>
      ...
      <div class="cell">
        ...
        <div class="cell-bd" style="height: 450px">
			...
			<div class="mb-3 details-container">
				...
				<div class="detailscell"> <a href="<?php echo url_for('@film?id=' . $filmNowDbo->getId() . '&key=' . $filmNowDbo->getUrlKey());?>" class="left"><img width="100" src="<?php echo filmsiFilmPhotoThumb($filmNowDbo->getFilename());?>" /></a>
        ...
        <div class="cell-bd" style="height: 450px">
			<?php foreach ($filmsNowTv as $filmNowTv):?>
			  <div class="mb-3 details-container">
				...
				<div class="detailscell"> <a href="<?php echo url_for('@film?id=' . $filmNowTv->getFilm()->getId() . '&key=' . $filmNowTv->getFilm()->getUrlKey());?>" class="left"><img width="100" src="<?php echo filmsiFilmPhotoThumb($filmNowTv->getFilm()->getFilename());?>" /></a>
      ...
      <div class="cell">
        ...
        <div class="cell-bd" style="height: 450px">
          <?php foreach ($filmsSoonInCinema as $filmSoonInCinema):?>
				...
				<div class="detailscell"> <a href="<?php echo url_for('@film?id=' . $filmSoonInCinema->getId() . '&key=' . $filmSoonInCinema->getUrlKey());?>" class="left"><img width="100" src="<?php echo filmsiFilmPhotoThumb($filmSoonInCinema->getFilename());?>" /></a>
        ...
        <div class="cell-bd" style="height: 450px">
          <?php foreach($filmsSoonDbo as $filmSoonDbo):?>
			<div class="mb-3 details-container">
				...
				<div class="detailscell"> <a href="<?php echo url_for('@film?id=' . $filmSoonDbo->getId() . '&key=' . $filmSoonDbo->getUrlKey());?>" class="left"><img width="100" src="<?php echo filmsiFilmPhotoThumb($filmSoonDbo->getFilename());?>" /></a>
        ...
        <div class="cell-bd" style="height: 450px">
          <?php foreach ($filmsSoonTv as $filmSoonTv):?>
			  <div class="mb-3 details-container">
				...
				<div class="detailscell"> <a href="<?php echo url_for('@film?id=' . $filmSoonTv->getId() . '&key=' . $filmSoonTv->getUrlKey());?>" class="left"><img width="100" src="<?php echo filmsiFilmPhotoThumb($filmSoonTv->getFilename());?>" /></a>
