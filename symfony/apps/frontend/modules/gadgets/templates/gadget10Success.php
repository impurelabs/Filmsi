...
<div class="cell" style="height:333px">
	<div class="cell-hd">
		<h5>Cele mai noi <span class="black">articole</span></h5>
	</div>
	<div class="cell-bd">
	...
	<span class="more-cell"><a target="_parent" href="<?php echo url_for('@articles');?>" class="smallwhite-link">vezi mai multe &raquo;</a></span>
</div>