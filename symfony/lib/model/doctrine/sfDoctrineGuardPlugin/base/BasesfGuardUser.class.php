 ...
 * @method sfGuardUser           setLocationId()            Sets the current record's "location_id" value
 ...
 * @method sfGuardUser           setLocation()              Sets the current record's "Location" value
 * @method sfGuardUser           setSfGuardUserPermission() Sets the current record's "sfGuardUserPermission" collection
 * @method sfGuardUser           setSfGuardUserGroup()      Sets the current record's "sfGuardUserGroup" collection
 * @method sfGuardUser           setRememberKeys()          Sets the current record's "RememberKeys" value
 * @method sfGuardUser           setForgotPassword()        Sets the current record's "ForgotPassword" value
 * @method sfGuardUser           setLibrary()               Sets the current record's "Library" value
 * @method sfGuardUser           setPhotoAlbum()            Sets the current record's "PhotoAlbum" value
 * @method sfGuardUser           setVideoAlbum()            Sets the current record's "VideoAlbum" value
 * @method sfGuardUser           setPerson()                Sets the current record's "Person" value
 * @method sfGuardUser           setFilm()                  Sets the current record's "Film" value
 * @method sfGuardUser           setFestivalEdition()       Sets the current record's "FestivalEdition" value
 * @method sfGuardUser           setCinema()                Sets the current record's "Cinema" value
 * @method sfGuardUser           setArticle()               Sets the current record's "Article" value
 * @method sfGuardUser           setStire()                 Sets the current record's "Stire" value
 * 
 * @package    filmsi
 * @subpackage model
