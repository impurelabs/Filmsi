...
<div class="spacer-bottom-m">
	...
	<a href="<?php echo url_for('@cinema_tickets?id=' . $cinema->getId() . '&key=' . $cinema->getUrlKey());?>" class="black-link">Pret bilete</a>
</div>
    ...
    <div class="cell spacer-bottom-m">
        ...
        <div class="cell-bd" style="padding:0">
        	<ul class="filterlist spacer-bottom-m">
                ...
                <li onclick="location.href='<?php echo url_for('@cinema_tickets?id=' . $cinema->getId() . '&key=' . $cinema->getUrlKey());?>'" class="active"><a href="<?php echo url_for('@cinema_tickets?id=' . $cinema->getId() . '&key=' . $cinema->getUrlKey());?>">Pret bilete<span class="filter-cioc"></span></a></li>
