...
<div class="cell-container8 spacer-top-m"> <!-- content column start -->
    ...
    <div class="normalcell left" style="width: 400px">
        <br /><br /><br /><br />
        <p class="bigstronggrey align-center">Stirea a fost publicata cu succes!<br ></p>
        <p class="align-center">Va aparea pe site dupa ce va fi aprobata de catre un administrator.</p>
