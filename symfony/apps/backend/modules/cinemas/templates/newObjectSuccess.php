...
<h4 class="mb-3">Creeaza Cinema Nou</h4>

<form id="the-form" action="<?php echo url_for('@default?module=cinemas&action=newObject');?>" method="post" enctype="multipart/form-data">
...
function initializeMap()
{
    ...
    var latlng = new google.maps.LatLng(45.9431610, 24.9667600);
    var myOptions = {
      zoom: 6,
      center: latlng,
