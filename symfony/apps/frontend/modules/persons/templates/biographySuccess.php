    ...
    <div class="cell spacer-bottom-m">
        ...
        <div class="cell-bd" style="padding:0">
            <ul class="filterlist spacer-bottom-m">
                <li onclick="location.href='<?php echo url_for('@person_biography?id=' . $person->getId() . '&key=' . $person->getUrlKey());?>'" class="active"><a href="<?php echo url_for('@person_biography?id=' . $person->getId() . '&key=' . $person->getUrlKey());?>">Biografie<span class="filter-cioc"></span></a></li>
...
<div class="cell-container5 spacer-left"> <!-- content column start -->
    ...
    <div class="normalcell spacer-bottom">
        <h4 class="spacer-bottom-m">Biografie</h4>
