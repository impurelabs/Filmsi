...
class CinemaPromotion extends BaseCinemaPromotion
{
	...
	public function deleteFiles()
	{
		...
		$response = $s3->delete_object(sfConfig::get('app_aws_bucket'), sfConfig::get('app_cinemapromotion_aws_s3_folder') . '/' . $this->getFilename());
		$response = $s3->delete_object(sfConfig::get('app_aws_bucket'), sfConfig::get('app_cinemapromotion_aws_s3_folder') . '/t-' . $this->getFilename());
		$response = $s3->delete_object(sfConfig::get('app_aws_bucket'), sfConfig::get('app_cinemapromotion_aws_s3_folder') . '/ts-' . $this->getFilename());
