...
<h4 class="mb-3">Editeaza categorie de articol</h4>

<form action="<?php echo url_for('@default?module=categories&action=edit');?>?id=<?php echo $form->getObject()->getId();?>" method="post">
