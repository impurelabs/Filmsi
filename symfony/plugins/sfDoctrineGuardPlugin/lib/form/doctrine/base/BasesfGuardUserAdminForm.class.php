...
class BasesfGuardUserAdminForm extends BasesfGuardUserForm
{
  ...
  public function setup()
  {
    ...
    $this->mergePostValidator(new sfValidatorSchemaCompare('password', sfValidatorSchemaCompare::EQUAL, 'password_again', array(), array('invalid' => 'Cele doua parole trebuie sa fie la fel')));
  }
}