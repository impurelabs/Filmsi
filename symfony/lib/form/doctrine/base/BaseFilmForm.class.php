...
abstract class BaseFilmForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'status_tv'            => new sfWidgetFormInputText(),
      'status_tv_year'       => new sfWidgetFormInputText(),
      'status_tv_month'		 => new sfWidgetFormInputText(),
      'status_tv_day'		 => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'status_tv'        => new sfValidatorPass(array('required' => false)),
      'status_tv_year'   => new sfValidatorInteger(array('required' => false)),
      'status_tv_month'  => new sfValidatorInteger(array('required' => false)),
      'status_tv_day'    => new sfValidatorInteger(array('required' => false)),
