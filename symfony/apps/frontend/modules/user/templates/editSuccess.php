<div class="left" style="width: 200px">
	...
	<br />
	<button class="user-menubutton-selected">Detalii personale</button>
	<br /><br />
	<button class="user-menubutton" id="user-alerts-button">Alerte informative</button>
	<br />
</div> <!-- user menu -->
	...
	<form id="user-register-form" method="post">
		...
		<div class="left" style="width: 350px;">
			...
			<div id="user-buttons-container">
				<div id="user-buttons">
					<a href="javascript: void(0)" id="register-submit-button" class="whitebutton-small-link">Salveaza</a>
					<a href="javascript: void(0)" id="user-detailsedit-cancel" class="ml-3">Anuleaza</a>
				</div>
			</div>
		</div>
		...
		<div class="left" style="width: 350px; margin-left: 20px">
			...
			<span class="smalltext">Parola Noua<br />(pentru a NU modifica parola, lasa urmatoarele doua campuri goale)</span><br />
			<?php echo $form['password']->render(array('class' => 'inpttxt0', 'style' => 'width: 300px'));?><br />
			<?php echo $form['password']->renderError();?><br />

			<span class="smalltext">Confirma parola noua</span><br />
...
$(document).ready(function(){
	$('#user-detailsedit-cancel').click(function(){
	...
	$('#register-submit-button').click(function(){
		...
		$.ajax({
			url: '<?php echo url_for('@default?module=user&action=edit');?>',
			type: 'post',
			data: {
