...
<div class="cell-container6"> <!-- left column start -->
	<form action="<?php echo url_for('@film_soon_in_cinema?');?>" method="get" id="filter-form">
...
<div class="cell-container5 spacer-left"> <!-- content column start -->
    ...
    <div class="spacer-bottom">
        ...
        <button class="normalbutton spacer-left-m" onclick="location.href='<?php echo url_for('@film_soon_in_cinema');?>'"><span class="icon-buttonbullet-green"></span> <span class="bigstronggreen">Arata filmele in curand</span></button>
    </div>
    ...
    <div class="cell-separator-dotted-top cell-separator-dotted-bottom innerspacer-bottom innerspacer-top"> <!-- page navigator start -->
        ...
        <?php if($currentPage > 1):?>
			<a href="<?php echo url_for('@film_soon_in_cinema');?>?<?php if ($parameterQuery != '') echo $parameterQuery . '&';?>p=<?php echo $currentPage - 1;?>"><span class="pagenav-back"></span></a>
		<?php endif;?>
		<?php for ($i = 1; $i <= $pageCount; $i++):?>
			<a href="<?php echo url_for('@film_soon_in_cinema');?>?<?php if ($parameterQuery != '') echo $parameterQuery . '&';?>p=<?php echo $i;?>"><span class="<?php echo $i == $currentPage ? 'pagenav-active' : 'pagenav';?>"><?php echo $i;?></span></a>
		<?php endfor;?>
		<?php if($currentPage < $pageCount):?>
		<a href="<?php echo url_for('@film_soon_in_cinema');?>?<?php if ($parameterQuery != '') echo $parameterQuery . '&';?>p=<?php echo $currentPage + 1;?>"><span class="pagenav-forward"></span></a>
		<?php endif;?>
