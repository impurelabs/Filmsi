...
<h4 class="mb-3">Creeaza Stire Noua</h4>

<form id="the-form" action="<?php echo url_for('@default?module=stires&action=newObject');?>" method="post" enctype="multipart/form-data">
