...
<div class="cell" style="height:518px">
	<div class="cell-hd">
		<h5>Nou pe <span class="black">DVD &amp; Bluray</span></h5>
	</div>
	<div class="cell-bd">
		<?php foreach($films as $film):?>
			<div class="mb-3 details-container">
				<div class="inline-block spacer-right-s" style="vertical-align:top"><a href="<?php echo url_for('@film?id=' . $film->getId() . '&key=' . $film->getUrlKey());?>"><img src="<?php echo filmsiFilmPhotoThumbS($film->getFilename());?>" /></a></div>
